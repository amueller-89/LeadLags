...
### Tested Accuracy
- **Clean synthetic signals**: ±15% relative error
- **Noisy signals** (SNR ~1): ±30% relative error
- **Frequency separation**: Successfully separates different lags at different frequencies

### Computational Complexity
- **Time**: O(N log N) per series due to FFT
- **Space**: O(N × M²) for M series, N samples
- **Recommended**: 5-10K samples minimum for reliable results

## Roadmap

### Phase 1: Data Pipeline & Spectral Analysis ✅
- [x] Binance data fetching
- [x] Data preprocessing & alignment
- [x] Spectral lead-lag detection
- [x] Visualization
- [x] CLI interface

### Phase 2: Graph Attention Networks (Coming Soon)
- [ ] Feature engineering (returns, volatility, volume)
- [ ] GAT implementation
- [ ] Training loop & evaluation
- [ ] Compare with spectral ground truth

### Phase 3: Temporal Extensions (Coming Soon)
- [ ] TGAT implementation
- [ ] Event stream format
- [ ] Temporal attention visualization
- [ ] Benchmark comparison

### Phase 4: Advanced Methods (Optional)
- [ ] Sheaf Neural Networks
- [ ] Hybrid spectral-ML approach
...
- FFT-based lead-lag detection: Based on cross-spectral density methods
- GAT: Veličković et al., "Graph Attention Networks" (ICLR 2018)
- TGAT: Xu et al., "Inductive Representation Learning on Temporal Graphs" (ICLR 2020)
